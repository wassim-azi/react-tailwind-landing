      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border-2 border-gray-200 rounded-xl overflow-hidden transition-all duration-300 hover:border-primary-300"
            >
              <button
        ...
        {/* Contact CTA */}
        <div className="mt-12 text-center p-8 bg-gradient-to-br from-primary-50 to-purple-50 rounded-xl">
          ...
          <button className="bg-accent-500 hover:bg-accent-600 text-white font-semibold px-8 py-3 rounded-lg transition-colors">
            Contact Support
